...
public class NonControllablePersonSteerableComponent implements Component, Steerable<Vector2>{
    ...
    public NonControllablePersonSteerableComponent (float x, float y) {
    	this.x = x;
    	this.y = y;
    	this.spawnX = x;
    	this.spawnY = y;
